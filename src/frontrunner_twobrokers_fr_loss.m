...
>agents agentinput = [
>                     (brokerexch1delay, brokerexch2delay,(broker      initxq agentinput (AgentState 0 0 (0,0))  (buyer_start_time+9))),
...
>                     (broker2exch1delay, broker2exch2delay,(broker    initxq agentinput (AgentState 0 0 (0,0))  buyer_start_time))
>                    ] 
>                    where 
>                    initxq = ([],[],[],[])
...
>                    (broker2exch1delay, broker2exch2delay) = (8,0)
...
>mmsizes = [1650,200,20,-20,40,-40,60,-60,80,-80,100,-100]
